...
async def send_with_photo(message_or_callback, photo_key, text, kb=None, is_edit=False):
...
async def admin_cmd(message: Message):
    ...
    await send_with_photo(message, "admin", "⚙️ Админ-панель:", InlineKeyboardMarkup(inline_keyboard=kb))

...
async def start_cmd(message: Message):
    ...
    photo_id = "AgACAgIAAxkBAAMFakGVOQ4eMNgZldjNjA3Xl069dWcAArEYaxt9nRBKb-VPC915U8MBAAMCAAN3AAM8BA"
...
"""
    photo_id = "AgACAgIAAxkBAAMHakGWaWWSae8Nsq5SSGXkQaBbqFYAArUYaxt9nRBKhX3i1KHaWbUBAAMCAAN3AAM8BA"
...
async def elite_cmd(message: Message):
    ...
    photo_id = "AgACAgIAAxkBAAMIakGYDGbjmMi5jX8SRmaZmuf_iR4AAsIYaxt9nRBKm9O4ViMOAAFaAQADAgADdwADPAQ"
...
async def tariffs_cmd(message: Message):
    ...
    photo_id = "AgACAgUAAxkBAAMTakGgJkCGC2C0Q7LwtzQefREd_OwAAjkPaxsqcAhWoZcvGRWF5LUBAAMCAAN3AAM8BA"
...
async def referrals_cmd(message: Message):
    ...
    photo_id = "AgACAgUAAxkBAAMNakGcvmjVTXZIJWM803K2GF4xYY4AAjIPaxsqcAhW7UzZsQsNW9IBAAMCAAN3AAM8BA"
...
async def rating_cmd(message: Message):
    photo_id = "AgACAgUAAxkBAAMUakGhWJyPjIaBrnZEGNP712g7xk4AAjoPaxsqcAhW2zGMRjBKM6oBAAMCAAN3AAM8BA"
...
# ---- ПЕРЕВОД С ФОТО И УВЕДОМЛЕНИЯМИ ----
@dp.message(F.text == "💸 Перевести")
async def transfer_cmd(message: Message, state: FSMContext):
    photo_id = "AgACAgUAAxkBAAMVakGiRcQPveKXbYZIkrL4csJEpN8AAjsPaxsqcAhWIImGYwsus50BAAMCAAN3AAM8BA"
...
async def giveaway_cmd(message: Message):
    photo_id = "AgACAgUAAxkBAAMWakGjTrWxuDgpRH38Of3a1uTgApsAAjwPaxsqcAhWKRYrzav2ZGIBAAMCAAN3AAM8BA"
...
async def earn_cmd(message: Message):
    user_id = message.from_user.id
    photo_id = "AgACAgUAAxkBAAMPakGeoaj2NxcI7BqMxrVr1G2uqeoAAjQPaxsqcAhWN_qLgOf7Zp4BAAMCAAN3AAM8BA"
...
async def more_cmd(message: Message):
    ...
    photo_id = "AgACAgUAAxkBAAMOakGd5ZEMpgygEn75eIhSTrBGy10AAjMPaxsqcAhWR48FLusPOEcBAAMCAAN3AAM8BA"
    ...
    if not is_elite_active(user_id):
        ...
        await message.answer_photo(
            photo=photo_id,
            caption="🔒 Доступно только с Elite Sub.",
            reply_markup=InlineKeyboardMarkup(inline_keyboard=kb)
        )
        return
...
async def support_cmd(message: Message):
    photo_id = "AgACAgUAAxkBAAMQakGe4fwOg3NteCOcfqUMDXuqudUAAjYPaxsqcAhW_W8O3gK4XjYBAAMCAAN3AAM8BA"
...
async def stats_cmd(message: Message):
    photo_id = "AgACAgUAAxkBAAMRakGfeKaLtpbExSOPgFzs69msSS4AAjcPaxsqcAhWTwcQQyARQPsBAAMCAAN3AAM8BA"
...
async def menu_cmd(message: Message):
    photo_id = "AgACAgUAAxkBAAMMakGb5Y9xscXI8O3iKfneZbFwCEcAAjEPaxsqcAhW95amcvhInNABAAMCAAN3AAM8BA"
    
    await message.answer_photo(
        photo=photo_id,
        caption="⚡ Дополнительное меню:",
...
async def tasks_menu(message: Message):
    ...
    photo_id = "AgACAgIAAxkBAAMJakGY9H6kk8bRlbeCiuFI76WY53YAAscYaxt9nRBKBeuLvcSQ4uIBAAMCAAN3AAM8BA"
    ...
    if not tasks:
        ...
        await message.answer_photo(
            photo=photo_id,
            caption="📋 Задания\n\nПока нет активных заданий. Создайте своё!",
            reply_markup=InlineKeyboardMarkup(inline_keyboard=kb)
        )
        return
...
async def create_task_start(callback: CallbackQuery, state: FSMContext):
    ...
    photo_id = "AgACAgIAAxkBAAMGakGVsBTAcsyftBPXi2TyXBITPkoA"
...
# ========== АДМИН-ПАНЕЛЬ С ФОТО (КНОПКИ В 2 РЯДА) ==========
...
async def admin_cmd(message: Message):
    ...
    photo_id = "AgACAgUAAxkBAAMXakGkelOapDmpjL0_vvp3XJyd5y0AAj0PaxsqcAhWjZ9b8E8WC24BAAMCAAN3AAM8BA"
